...
import { User, Mail, Briefcase, Building, Moon, Sun, Bell, Shield, Save } from 'lucide-react'
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="employeeId" defaultValue={user.staff_no || 'Not assigned'} className="pl-9" disabled />
                </div>
              </div>
              <div className="space-y-2">
